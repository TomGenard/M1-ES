...
def test_value_positive_and_integer(value_to_test) :
    ...
    if (value_to_test < 0) :
        sys.stderr.write("ERROR : Valeur negative\n")
        sys.exit(1)
...
def test_value_max_above_min(value_max, value_min) :
    if (value_max < value_min) :
        sys.stderr.write("ERROR : Valeur maximale inferieure a valeur minimale\n")
        sys.exit(1)
    elif (value_max == value_min) :
        sys.stderr.write("ERROR : Valeur maximale inferieure et valeur minimale egales\n")
        sys.exit(1)
